...
@section('app-content')
    <h4 class="text-center my-3">Laporan Pengajuan Cuti</h4>
    <section class="p-3">
        <strong>
        ...
        @endif
        <br>
        <span style="width: 150px; display: inline-block;">Jenis Cuti</span>
        <span>: {{ $filter['jenis_cuti'] ?? 'Semua Jenis Cuti' }}</span>
        <br>
