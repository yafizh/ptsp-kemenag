                        ...
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="jenis_cuti" class="form-control" id="jenis_cuti">
                                    <option value="" selected>Semua Jenis Cuti</option>
                                    @foreach ($jenisCuti as $item)
                                        <option value="{{ $item->id }}"
                                            {{ ($_POST['jenis_cuti'] ?? '') == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" disabled
                                value="{{ $filter['jenis_cuti'] ?? 'Semua Jenis Cuti' }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-end">
                            <form action="" method="POST" target="_blank">
                                ...
                                <input type="text" hidden name="jenis_cuti" value="{{ $_POST['jenis_cuti'] ?? '' }}">
                            ...
                            <tbody>
                                @foreach ($pengajuan as $item)
                                    <tr>
                                        ...
                                        <td class="align-middle">{{ $item['jenis_cuti'] }}</td>
