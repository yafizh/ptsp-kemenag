                        ...
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="jenis_izin" class="form-control" id="jenis_izin">
                                    <option value="" selected>Semua Jenis Izin</option>
                                    @foreach ($jenisIzin as $item)
                                        <option value="{{ $item->id }}"
                                            {{ ($_POST['jenis_izin'] ?? '') == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" disabled
                                value="{{ $filter['jenis_izin'] ?? 'Semua Jenis Izin' }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-end">
                            <form action="" method="POST" target="_blank">
                                ...
                                <input type="text" hidden name="jenis_izin" value="{{ $_POST['jenis_izin'] ?? '' }}">
