...
@section('app-content')
    <h4 class="text-center my-3">Laporan Pengajuan SPDP</h4>
    <section class="p-3">
        <strong>
        ...
        @endif
        <br>
        <span style="width: 150px; display: inline-block;">Jenis Transportasi</span>
        <span>: {{ $filter['jenis_kendaraan'] ?? 'Semua Jenis Transportasi' }}</span>
        <br>
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="text-center align-middle">Jenis Trasportasi</th>
