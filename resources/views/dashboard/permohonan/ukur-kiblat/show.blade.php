    ...
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-12 col-md-6">
                <h3>Detail Permohonan Pengukuran Kiblat</h3>
            </div>
            <div class="col-12 col-md-6 d-flex justify-content-end">
                <a href="/{{ auth()->user()->status->route() }}/permohonan-ukur-kiblat" class="btn btn-secondary">Kembali</a>
            </div>
        </div>
        <div class="row">
            @if (session('success'))
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Nomor Telepon Ketua</label>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Nama Mesjid/Mushola</label>
                                    <input type="text" class="form-control"
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Nomor Telepon Mesjid/Mushola</label>
                                    <input type="text" class="form-control"
                        ...
                        @if (is_null($permohonan['status']))
                            <div class="d-flex justify-content-end gap-1">
                                <form
                                    action="/{{ auth()->user()->status->route() }}/permohonan-ukur-kiblat/{{ $permohonan['id'] }}/tolak"
                                    method="POST">
                                    @csrf
                                ...
                                <form
                                    action="/{{ auth()->user()->status->route() }}/permohonan-ukur-kiblat/{{ $permohonan['id'] }}/terima"
                                    method="POST">
                                    @csrf
