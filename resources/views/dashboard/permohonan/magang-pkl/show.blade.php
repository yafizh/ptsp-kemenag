    ...
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-12 col-md-6">
                <h3>Detail Permohonan Magang/PKL</h3>
            </div>
            <div class="col-12 col-md-6 d-flex justify-content-end">
                <a href="/{{ auth()->user()->status->route() }}/permohonan-magang-pkl" class="btn btn-secondary">Kembali</a>
            </div>
        </div>
        <div class="row">
            @if (session('success'))
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $permohonan['asal_sekolah'] }}"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Alamat Sekolah/Kampus</label>
                                    <textarea class="form-control" disabled>{{ $permohonan['alamat_sekolah'] }}</textarea>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                        ...
                        @if (is_null($permohonan['status']))
                            <div class="d-flex justify-content-end gap-1">
                                <form
                                    action="/{{ auth()->user()->status->route() }}/permohonan-magang-pkl/{{ $permohonan['id'] }}/tolak"
                                    method="POST">
                                    @csrf
                                ...
                                <form
                                    action="/{{ auth()->user()->status->route() }}/permohonan-magang-pkl/{{ $permohonan['id'] }}/terima"
                                    method="POST">
                                    @csrf
